...
public class Main {
    public static void main(String[] args) {
        Planeta planeta1 = new Planeta("Marte", 2, 6.39e23, 163.2e9, 6792, 225, Planeta.TipoPlaneta.TERRESTRE, true, 1.88, 1.03);
        Planeta planeta2 = new Planeta("Júpiter", 79, 1.898e27, 1431e12, 139822, 778, Planeta.TipoPlaneta.GASEOSO, true, 11.86, 0.41);
